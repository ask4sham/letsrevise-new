...
Notes:
- Output: reports/SPRINT_ORDER_&lt;SPEC&gt;_YYYY-MM-DD.md
...
Usage:
- node backend/scripts/buildSprintOrderFromCoverage.js --specKey aqa-gcse-biology
- node backend/scripts/buildSprintOrderFromCoverage.js --specKey aqa-gcse-biology --apply
