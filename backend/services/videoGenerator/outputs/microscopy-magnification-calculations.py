...
class LessonScene(Scene):
    def construct(self):
        ...
        place = ImageMobject("C:\\dev\\letsrevise-new\\backend\\services\\videoGenerator\\assets\\microscope.png")
        ...
        text.scale_to_fit_width(5.5).to_edge(LEFT).next_to(title, DOWN, buff=0.4)
        self.play(FadeIn(text))
        place = ImageMobject("C:\\dev\\letsrevise-new\\backend\\services\\videoGenerator\\assets\\iam-triangle.png")
        ...
        text.scale_to_fit_width(5.5).to_edge(LEFT).next_to(title, DOWN, buff=0.3)
        self.play(FadeIn(text))
        place = ImageMobject("C:\\dev\\letsrevise-new\\backend\\services\\videoGenerator\\assets\\plant-cell.png")
        place.scale_to_fit_width(4).to_edge(RIGHT)
        self.play(FadeIn(place))
        self.wait(10)
        ...
        text.scale_to_fit_width(5.5).to_edge(LEFT).next_to(title, DOWN, buff=0.3)
        self.play(FadeIn(text))
        place = ImageMobject("C:\\dev\\letsrevise-new\\backend\\services\\videoGenerator\\assets\\root-hair-cell.png")
        place.scale_to_fit_width(4).to_edge(RIGHT)
        self.play(FadeIn(place))
        self.wait(10)
