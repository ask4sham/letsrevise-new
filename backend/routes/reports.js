 ...
 * Delegates to studentRecommendationsService.
 */
router.get("/students/me/recommendations", auth, async (req, res) => {
  try {
    const { getRecommendations } = require("../services/studentRecommendationsService");
    ...
    const data = await getRecommendations(userId, { days, limit });
