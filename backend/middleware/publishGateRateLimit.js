/**
 * PR-014.1a: Rate limit /api/publish-gate — 10/min teacher, 30/min admin.
 */
...
module.exports = function publishGateRateLimit(req, res, next) {
  ...
  if (entry.count > limit) {
    return res.status(429).json({
      error: "Too many publish check requests. Please wait a moment and try again.",
    });
  }
