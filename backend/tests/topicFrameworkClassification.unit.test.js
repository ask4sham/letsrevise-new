  ...
  describe("Ecology unit", () => {
    test.each([
      ...
      [
        ...
        "classification_grid",
        "high",
        "ecology_levels_organisation_keywords",
      ],
      ["Ecology", "system_flow", "physiology_system_flow_map", "high", "ecology_topic_keywords"],
      [
        "Required Practical: Ecosystems",
        "practical_method",
        "practical_method_flow",
        "high",
        "ecology_practical_keywords",
      ],
      [
        ...
        "high",
        "ecology_environmental_cause_effect_keywords",
      ],
      [
