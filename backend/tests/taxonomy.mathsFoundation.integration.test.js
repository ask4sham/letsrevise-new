/**
 * GET /api/taxonomy/aqa-gcse-maths-foundation — returns AQA GCSE Maths (Foundation) taxonomy.
 */
const request = require("supertest");
const app = require("../app");

describe("GET /api/taxonomy/aqa-gcse-maths-foundation", () => {
  test("returns normalized taxonomy payload", async () => {
    ...
    expect(res.body).toHaveProperty("specKey", "aqa-gcse-maths-foundation");
