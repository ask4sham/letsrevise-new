...
const BRIEF_KIND_HEADING =
  /^(DRAG & DROP BRIEF|TEXT → IMAGE DESIGN BRIEF|IMAGE \+ DROP ZONES DESIGN BRIEF|BRAIN DIAGRAM BRIEF|REFLEX ARC DIAGRAM BRIEF|EYE DIAGRAM BRIEF|CELL DIAGRAM BRIEF|REFLEX ARC STEP-BY-STEP BRIEF|NERVOUS SYSTEM STEP-BY-STEP BRIEF|HOMEOSTASIS STEP-BY-STEP BRIEF|MITOSIS STEP-BY-STEP BRIEF|DIGESTION STEP-BY-STEP BRIEF|PHOTOSYNTHESIS STEP-BY-STEP BRIEF|DIAGRAM BRIEF|STEP-BY-STEP BRIEF)/m;
