...
describe("LessonStudentBlockRenderer", () => {
  it("renders checkpoint blocks inline in the student block list", () => {
    render(
  ...
  it("passes text-to-image matchMode from dragDropLayout to DragDropMatchBlock", () => {
    render(
      <LessonStudentBlockRenderer
        {...baseProps}
        block={{
          ...
          pairs: [
            {
              ...
              prompt: "Chloroplast",
              answer: "site",
              imageUrl: "https://example.com/chloroplast.png",
              imageAlt: "Chloroplast diagram",
            },
          ],
        }}
      />
    );
    const ddm = screen.getByTestId("drag-drop-match");
    expect(ddm).toHaveAttribute("data-match-mode", "text-to-image");
  });
});
