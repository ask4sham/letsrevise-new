...
> = {
  ...
  equipment: { editorType: "text", role: "equipment", defaultTitle: "Equipment" },
  method: { editorType: "text", role: "method", defaultTitle: "Method" },
  "results-table": { editorType: "text", role: "resultsTable", defaultTitle: "Results Table" },
  "evaluation-grid": { editorType: "text", role: "evaluationGrid", defaultTitle: "Evaluation Grid" },
  "practical-purpose": { editorType: "text", role: "practicalPurpose", defaultTitle: "Practical Purpose" },
  "scientific-background": { editorType: "text", role: "concept", defaultTitle: "Scientific Background" },
  hypothesis: { editorType: "text", role: "hypothesis", defaultTitle: "Hypothesis / Prediction" },
  variables: { editorType: "text", role: "variables", defaultTitle: "Variables" },
  "processing-results": { editorType: "text", role: "processingResults", defaultTitle: "Processing Results" },
  analysis: { editorType: "text", role: "analysis", defaultTitle: "Analysis" },
