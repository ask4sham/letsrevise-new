 ...
 * Uses generatePracticeSet with quiz_mcq, quiz_short.
    ...
    return (
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="mt-4 p-4 border border-gray-200 rounded-lg">
          <p className="text-gray-700">No quiz questions available for this topic yet.</p>
          <p className="mt-2 text-sm text-gray-500">
            Ask your teacher to add quiz questions for {topicKeyToTitle(topicKey)}.
          </p>
        </div>
      </div>
    );
