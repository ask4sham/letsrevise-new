...
type StudentLessonCard = {
  ...
  // ✅ NEW: GCSE tier label ('' / foundation / higher)
  tier: string;
};
...
const StudentDashboard: React.FC = () => {
    ...
    try {
      ...
      const mapped: StudentLessonCard[] = raw.map((l) => {
        ...
        return {
          ...
          examBoardName,
          tier: safeTier, // '' | foundation | higher
        };
      });
  ...
  const filteredLessons = useMemo(() => {
    ...
    // ✅ GCSE tier filter – only applies when level is GCSE
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            {/* ✅ GCSE Tier filter – only visible when level = GCSE */}
            {filters.level === "GCSE" && (
              <div>
                <label
                  style={{
                ...
                >
                  ...
                  <div style={{ padding: "20px", flexGrow: 1 }}>
                    ...
                    >
                      ...
                      {/* Optional chip showing tier if available */}
