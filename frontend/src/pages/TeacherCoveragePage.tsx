/**
 * PR-COVERAGE-1: Teacher Content Coverage — topic-level counts for Flashcards, Quiz, Exam, Past Paper Qs.
...
import { fetchTopicCoverage, type TopicCoverageResponse, type TopicCoverageRow } from "../api/topicCoverage";
  ...
  return (
    <div style={{ maxWidth: 1280, margin: "0 auto", padding: 24, width: "100%", boxSizing: "border-box" }}>
      ...
      <p style={{ color: "#6b7280", marginBottom: 20 }}>
        See which taxonomy topics have content in Flashcards, Quiz, Exam Questions, and Past Paper Questions. Build content systematically.
      </p>
      ...
      {!loading && data && (
        <>
          <div style={{ marginBottom: 16, fontSize: 14, color: "#6b7280" }}>
            <strong>Totals:</strong> {data.totals.topics} topics · {data.totals.topicsWithAny} with any content · {data.totals.topicsFullyCovered} fully covered (all 5 banks)
          </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
                ...
                <tbody>
                  {filteredUnits.map((unit) =>
                    unit.topics.map((row: TopicCoverageRow) => (
                      <tr
                        key={row.namespacedTopicKey}
                        style={{
