export const REQUIRED_SECTION_RULES = [
  { key: "objectives", label: "Lesson Objectives" },
...
export const REQUIRED_TEXT_MARKERS = [
  {
    key: "objectives-opening",
    label: "Objectives opening line",
    test: (text = "") =>
      String(text).includes("At the end of this lesson, you should be able to:"),
  },
  {
  ...
  },
  {
    ...
    test: (text = "") =>
      /Weak answer:/i.test(String(text)) &&
      /Better answer:/i.test(String(text)) &&
      /Full-mark answer:/i.test(String(text)),
  },
];
