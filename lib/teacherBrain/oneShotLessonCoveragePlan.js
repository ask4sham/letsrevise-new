...
function formatSlotAssignments(plans, slotDefs) {
  ...
  lines.push(
    "",
    "RULE: If reflex arc pathway (or the central concept) is already tested in drag/drop and step-by-step,",
    "do NOT create another simple pathway/sequence recall checkpoint — use synapse, spinal cord,",
    "reflex speed, effector, accommodation, thermoregulation, or brain regions instead.",
    "",
