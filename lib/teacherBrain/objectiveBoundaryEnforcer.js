...
function framingFieldForBlock(block) {
  ...
  if (
    ...
    title.includes("revision objectives") ||
    title.includes("lesson objectives")
  ) {
...
function formatObjectiveBoundaryAppendix(profile, mode = getSubTopicBoundaryMode()) {
  ...
  return [
    ...
    "Revision objectives, WALT, WILF, success criteria, prior knowledge and key questions must stay inside this sub-topic.",
    enforceNote,
    "",
