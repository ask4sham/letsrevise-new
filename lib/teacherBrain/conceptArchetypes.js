...
const MATHS_PROCEDURE = {
  archetypeKey: "maths-procedure",
  label: "Procedure",
  subjectKeys: ["maths"],
  matchPatterns: [/algebra/i, /equation/i, /solving/i, /factoris/i, /expand/i, /simultaneous/i],
  coreModelPattern: "Identify type → select method → step-by-step working → check answer",
  progressionSteps: ["recognise problem type", "method", "worked steps", "check"],
  typicalDiagrams: ["number line", "balance method illustration"],
  commonMisconceptions: ["Sign errors", "Skipping inverse operations"],
  defaultAssessmentSkills: ["calculate", "explain"],
  reasoningTemplate: "Problem type → rule applied → simplified result → verification",
};

const MATHS_ALGEBRAIC = {
  archetypeKey: "maths-algebraic-manipulation",
  label: "Algebraic Manipulation",
  subjectKeys: ["maths"],
  matchPatterns: [/simplif/i, /rearrang/i, /substitut/i, /expression/i, /formula/i],
  coreModelPattern: "Identify structure → apply rule → simplify → state final form",
  progressionSteps: ["identify", "rule", "manipulate", "simplify"],
  typicalDiagrams: ["area model for expansion"],
  commonMisconceptions: ["Collecting unlike terms", "Dividing incorrectly across brackets"],
  defaultAssessmentSkills: ["calculate", "explain"],
  reasoningTemplate: "Expression structure → valid operation → equivalent form",
};
...
const MATHS_GRAPH = {
  ...
  label: "Graph",
  subjectKeys: ["maths"],
  matchPatterns: [/graph/i, /plot/i, /gradient/i, /coordinate/i, /linear/i, /quadratic/i],
  coreModelPattern: "Axes/scale → plot → feature identification (gradient, intercept, turning point)",
  progressionSteps: ["axes", "plot/sketch", "read features", "interpret", "apply"],
  typicalDiagrams: ["coordinate grid", "real-world graph"],
  commonMisconceptions: ["Scale errors", "Gradient as rise only without run"],
  defaultAssessmentSkills: ["interpret-data", "calculate", "explain"],
  reasoningTemplate: "Graph feature → calculation → meaning in context",
};
...
const MATHS_PROBABILITY = {
  ...
  label: "Probability",
  subjectKeys: ["maths"],
  matchPatterns: [/probability/i, /chance/i, /tree diagram/i, /conditional/i, /expected/i],
  coreModelPattern: "Sample space → event → P(event) → combined/conditional rules",
  progressionSteps: ["sample space", "single event", "combined events", "interpret"],
  typicalDiagrams: ["tree diagram", "Venn diagram"],
  commonMisconceptions: ["Gambler's fallacy", "Adding probabilities for non-exclusive events incorrectly"],
  defaultAssessmentSkills: ["calculate", "explain"],
  reasoningTemplate: "Outcomes listed → favourable/total → probability rule applied",
};
...
const MATHS_STATISTICS = {
  ...
  label: "Statistics",
  subjectKeys: ["maths"],
  matchPatterns: [/statistic/i, /mean/i, /median/i, /spread/i, /histogram/i, /cumulative/i],
  coreModelPattern: "Data → summary measure → interpretation → comparison",
  progressionSteps: ["collect/represent", "calculate", "compare", "interpret"],
  typicalDiagrams: ["histogram", "box plot", "cumulative frequency"],
  commonMisconceptions: ["Mean vs median in skewed data", "Confusing frequency density"],
  defaultAssessmentSkills: ["calculate", "interpret-data", "compare"],
  reasoningTemplate: "Data set → measure calculated → what it reveals → comparison",
};

const MATHS_PROOF = {
  archetypeKey: "maths-proof-reasoning",
  label: "Proof / Reasoning",
  subjectKeys: ["maths"],
  matchPatterns: [/proof/i, /show that/i, /justify/i, /reasoning/i, /geometric/i],
  coreModelPattern: "Given → logical step → therefore → QED",
  progressionSteps: ["state given", "deductive steps", "conclusion"],
  typicalDiagrams: ["annotated geometric diagram"],
  commonMisconceptions: ["Assuming what must be proved", "Gaps in logic"],
  defaultAssessmentSkills: ["justify", "explain"],
  reasoningTemplate: "Known fact → deduction → next fact → conclusion",
};
...
const HISTORY_CONSEQUENCE = {
  ...
  label: "Consequence",
  subjectKeys: ["history"],
  matchPatterns: [/consequence/i, /impact/i, /result/i, /treaty/i, /versailles/i, /aftermath/i],
  coreModelPattern: "Event → immediate impact → long-term legacy",
  progressionSteps: ["event recap", "immediate effects", "long-term legacy", "evaluation"],
  typicalDiagrams: ["timeline of consequences"],
  commonMisconceptions: ["Only political consequences listed", "No short/long term distinction"],
  defaultAssessmentSkills: ["explain", "evaluate", "use-evidence"],
  reasoningTemplate: "Event → effect on group/nation → wider historical significance",
};
...
const HISTORY_SIGNIFICANCE = {
  ...
  label: "Significance",
  subjectKeys: ["history"],
  matchPatterns: [/significance/i, /important/i, /impact/i, /legacy/i],
  coreModelPattern: "Event/person → immediate importance → long-term legacy → criteria of significance",
  progressionSteps: ["describe", "immediate significance", "long-term legacy", "judgement"],
  typicalDiagrams: ["significance criteria diagram"],
  commonMisconceptions: ["Significance asserted without criteria"],
  defaultAssessmentSkills: ["evaluate", "use-evidence"],
  reasoningTemplate: "Criteria → evidence → judgement of significance",
};
