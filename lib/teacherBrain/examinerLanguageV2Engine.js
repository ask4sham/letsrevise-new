...
function buildExaminerLanguageV2PromptSection(meta = {}) {
  ...
  if (profile?.examinerLanguageV2) return buildExaminerLanguageV2Appendix(profile);
  const { buildSubjectIntelligenceExaminerFallback } = require("./subjectIntelligenceEngine");
  return buildSubjectIntelligenceExaminerFallback(meta);
}
