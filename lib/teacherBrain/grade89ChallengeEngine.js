...
function buildGrade89ChallengePromptSection(meta = {}) {
  ...
  if (profile?.grade89Challenge) return buildGrade89ChallengeAppendix(profile);
  const { buildSubjectIntelligenceGrade89Fallback } = require("./subjectIntelligenceEngine");
  return buildSubjectIntelligenceGrade89Fallback(meta);
}
