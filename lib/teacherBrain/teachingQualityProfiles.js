...
const HOMEOSTASIS_TEACHING_QUALITY = {
  ...
  coreLearningDiscipline: {
    ...
    progressionMap: {
      ...
      coreModel: "overview",
      coreTeaching: "mechanism",
      workedExample: "application",
      examPractice: "evaluation",
      summary: "takeaway",
    },
    diagramGuidance:
      "Caption what the student should notice in the feedback loop — receptors, coordination centre, effectors — not the paragraph definition of homeostasis.",
    summaryTakeaways: [
      "Negative feedback restores optimum conditions.",
      "Examiners expect named receptors, coordination centre, and effectors.",
      "Link mechanism to return towards set point.",
    ],
    examPracticeStems: [
      "Explain how the body responds when core temperature rises during exercise.",
      "Evaluate whether sweating alone controls body temperature.",
    ],
    forbiddenRepeats: [
      "Do not redefine homeostasis in Core Teaching, Summary, or Exam Practice.",
      "Do not repeat the full thermoregulation pathway in Summary.",
    ],
  },
};
...
const NERVOUS_SYSTEM_TEACHING_QUALITY = {
  ...
  coreLearningDiscipline: {
    ...
    diagramGuidance:
      "Caption the direction of impulse travel and what each neurone type does — do not restate the stimulus → response definition.",
    summaryTakeaways: [
      "Electrical impulses travel along neurones; synapses use neurotransmitters.",
      "Sensory → CNS → motor pathway must be named in sequence.",
      "Reflex arcs bypass conscious processing for speed.",
    ],
    examPracticeStems: [
      "Explain how a reflex arc produces a rapid response.",
      "Compare roles of sensory, relay and motor neurones.",
    ],
    forbiddenRepeats: [
      "Do not redefine neurones or reflex arc after the Definition block.",
      "Do not repeat the block 6 pathway list in Summary or Exam Practice.",
    ],
  },
};
...
const THE_EYE_TEACHING_QUALITY = {
  ...
  coreLearningDiscipline: {
    ...
    diagramGuidance:
      "Caption what light path and lens shape change the student should notice — not the paragraph explaining accommodation.",
    summaryTakeaways: [
      "Cornea and lens refract light onto the retina.",
      "Accommodation changes lens shape for near objects.",
      "Retina detects light; the brain interprets the image.",
    ],
    examPracticeStems: [
      "Explain how the eye focuses on a near object.",
      "Evaluate whether corneal refraction alone produces a sharp retinal image.",
    ],
    forbiddenRepeats: [
      "Do not redefine accommodation after the Definition block.",
      "Do not repeat cornea → lens → retina in Summary.",
    ],
  },
};
