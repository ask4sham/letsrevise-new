...
function classifyBlockToArchitectureSlot(block) {
  ...
  if (role === "lessonobjectives" || title.includes("objectives") || hay.includes("lesson objectives")) {
    return "objectives";
  }
  if (role === "priorknowledge" || title.includes("prior knowledge")) return "priorKnowledge";
  if (title.includes("definition") || hay.includes("definition")) return "definition";
  if (
  ...
  if (title.includes("core model") || hay.includes("core model")) return "coreModel";
  if (title.includes("key examples") || hay.includes("key examples")) return "keyExamples";
  if (title.includes("exam vocabulary") || hay.includes("exam vocabulary")) return "examVocabulary";
